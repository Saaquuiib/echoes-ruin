...
(() => {
  ...
  const SPRITE_FLASH_INTENSITY = 20;
  const SpriteFlash = (() => {
  ...
  try {
    ...
    const stats = {
      hpMax: 100, hp: 100,
      stamMax: 100, stam: 100, stamRegenPerSec: 15,
